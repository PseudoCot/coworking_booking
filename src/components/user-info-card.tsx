  ...
  return (
    <div className="user-acc__info-wrapper">
      ...
      <div className="user-acc__info-btns">
        <button className="user-acc__info-edit-btn light-btn btn-reset" onClick={handleEditClick}>Редактировать</button>
        <button className="user-acc__info-change-password-btn light-btn btn-reset"
