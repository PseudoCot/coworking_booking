...
export default function MapPointSVG({ classNames }: MapPointSVGProps): JSX.Element {
  return (
    <svg className={classNames} width="14" height="19" viewBox="0 0 14 19" fill="none" xmlns="http://www.w3.org/2000/svg">
